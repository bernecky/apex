...
$ZTYPE $FNAME($YTYPE y, int QUADio)
...
int[] FixHeap(int[] heap, $YTYPE v, int root, 
...
int[] FixDHeap(int[] heap, $YTYPE v, int root, 
        int heapitem, int heapsize)
{ /* Restore heap invariant: parent<= both children */
 vacant = root;
 lchild = 1+vacant+vacant;
