 r←sis EmitInnerProductOneTRANSPOSE fns;f;sis;sis2;fnsf;fnsg;gc;fnm;gnm;dfnm;fct;fzt;gct;gzt;k;fnsred;rednm;gen
 ...
 sis←'$CTYPE'Strepl(E sis),TSAC fct
 sis←'$CT'Strepl(E sis),E,fct
 sis←'$ZTYPE'Strepl(E sis),TSAC fzt
