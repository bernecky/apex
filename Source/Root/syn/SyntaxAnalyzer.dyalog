 r←x SyntaxAnalyzer y;c;sig;bt;state;states;i;stk;ns;Stn;Stf;Stx;Stl;Sta;Sto;Str;Std;ast;astp;stkp;src;tok;j;sig;astrows;clsassign;clsrbr;clslbr;clschar;clslamp;clsconj;clssep;clsfn;clsgoto;clsid;clsctl;clscolon;clssemic;clsadverb;clsnum;clslpar;clsqq;clsrpar;clsspace;clsexpn;clsqdnm;Stkstate;Stkvalue;Stktokcl;signal;lineno;ast
